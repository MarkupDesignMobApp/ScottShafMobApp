    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, padding: responsiveScreenWidth(4), }}>
                ...
                <Text style={{ fontSize: 14, fontWeight: '600', margin: 10, }}>Help us personalize your experience</Text>
                ...
                <ScrollView>
                    ...
                    <View style={[styles.fieldWrapper]}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: 'space-between' }}>
                            <AppButton style={{ backgroundColor: '#fff', borderColor: '#3478f6', borderWidth: 1, width: responsiveScreenWidth(40), }} Textcolor="#3478f6" onPress={() => Alert.alert('hi')} title='18-24' />
                            <AppButton style={{ width: responsiveScreenWidth(40) }} onPress={() => Alert.alert('hi')} title='25-34' />
                        </View>

                        <View style={{ flexDirection: "row", justifyContent: 'space-between' }}>
                            <AppButton style={{ backgroundColor: '#fff', borderColor: '#3478f6', borderWidth: 1, width: responsiveScreenWidth(40), }} Textcolor="#3478f6" onPress={() => Alert.alert('hi')} title='18-24' />
                            <AppButton style={{ backgroundColor: '#fff', borderColor: '#3478f6', borderWidth: 1, width: responsiveScreenWidth(40), }} onPress={() => Alert.alert('hi')} title='25-34' />
                        </View>
                    </View>
