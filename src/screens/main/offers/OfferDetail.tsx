        ...
        <SafeAreaProvider>
            ...
            >
                ...
                <View style={styles.header}>
                    ...
                    <TouchableOpacity>
                        <Image source={require('../../../../assets/image/next.png')} style={{ width: 22, height: 22 }} />
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.card}>
                    <ScrollView style={{ maxHeight: 350 }}>
                        ...
                        <Text style={styles.offerDesc}>
                            Enjoy a special discount on your favorite coffee drinks. Valid for all sizes and customizations.
                        </Text>

                        <View style={styles.infoRow}>
                            <View style={styles.infoItem}>
                                <Image source={require('../../../../assets/image/calendar.png')} style={{ width: 22, height: 22 }} />

                                <Text style={styles.infoText}>Valid until Dec 31, 2025</Text>
                            </View>
                            <View style={styles.infoItem}>
                                <Image source={require('../../../../assets/image/multiple.png')} style={{ width: 22, height: 22 }} />
                        ...
                        <View style={styles.redeemBox}>
                            ...
                            {["Visit any participating Brand Name location", "Show this code at check out", "Enjoy your discounted coffee!"].map((item, i) => (
